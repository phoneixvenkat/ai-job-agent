...
from database.mysql_db import update_application_status, save_adaptive_pattern
...
Be direct and constructive. Format as plain text."""
...
def handle_need_more_info(app_id: int, job: dict) -> dict:
    ...
    prompt = f"""This job application needs more information before applying.

Job: {job.get('title')} at {job.get('org')}
Description: {job.get('description', '')[:500]}

What key information is missing that would help decide whether to apply?
List 3 specific questions to research. Be brief."""
